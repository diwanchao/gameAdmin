    ...
    jet.extend(jeDatePick.prototype,{
        ...
        getValue : function (valobj) {
            var that = this, valCell = that.valCell,
				...
				timeh = opts.initFormat ? opts.initFormat.hh : result.GetHours(), timem = opts.initFormat ? opts.initFormat.mm : result.GetMinutes(), times = opts.initFormat ? opts.initFormat.ss : result.GetSeconds();
