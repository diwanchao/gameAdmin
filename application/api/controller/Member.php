...
class Member extends Base
{
	...
	public function shareholderList()
	{
		...
		$data = Db::name('menber')
		->alias('m1')
		->field('m1.id,m2.user_name AS general_name,m1.user_name,m1.user_number,IFNULL(m3.count_user,0),m1.blance AS quick_open_quote,m1.create_time,m1.login_time,m1.`status`,m1.bet_status')
